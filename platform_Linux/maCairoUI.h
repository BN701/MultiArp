...
//        bool PollEvents(bool & gotKeyData, ItemMenu::key_type_t & curKey, xcb_keysym_t & sym);
        bool PollEvents(bool & gotKeyData, BaseUI::key_command_t & key);
//        bool KeyInput(uint8_t keycode, uint16_t state, ItemMenu::key_type_t & curKey, xcb_keysym_t  & sym);
